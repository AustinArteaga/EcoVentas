    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <header className="border-b bg-white/80 backdrop-blur-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-gray-900">UniMarket</span>
          </div>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          <h1 className="text-5xl font-bold text-gray-900 mb-6">
            ...
            <span className="text-blue-600 block">Estudiantes Universitarios</span>
          </h1>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">¿Por qué elegir UniMarket?</h2>
      ...
      <section className="py-20 px-4 bg-blue-600 text-white">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Únete a la comunidad de estudiantes que ya están comprando y vendiendo en UniMarket
          </p>
          <Link href="/register">
      ...
      <footer className="bg-gray-900 text-white py-8 px-4">
        <div className="container mx-auto text-center">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <span className="text-lg font-semibold">UniMarket</span>
          </div>
          <p className="text-gray-400">© 2024 UniMarket. Plataforma exclusiva para estudiantes universitarios.</p>
        </div>
      </footer>
    </div>
  )
